...
type BridgeTemplate_ITF interface {
	...
	BridgeTemplate_PTR() *BridgeTemplate
}
...
func callbackBridgeTemplatece8f65_Constructor(ptr unsafe.Pointer) {
	this := NewBridgeTemplateFromPointer(ptr)
...
func callbackBridgeTemplatece8f65_SendVariantListMap(ptr unsafe.Pointer, v0 unsafe.Pointer, v1 C.struct_Moc_PackedList, v2 C.struct_Moc_PackedList) {
	if signal := qt.GetSignal(ptr, "sendVariantListMap"); signal != nil {
		(*(*func(*std_core.QVariant, []*std_core.QVariant, map[string]*std_core.QVariant))(signal))(func() *std_core.QVariant {
			tmpValue := std_core.NewQVariantFromPointer(v0)
			qt.SetFinalizer(tmpValue, (*std_core.QVariant).DestroyQVariant)
			return tmpValue
		}(), func(l C.struct_Moc_PackedList) []*std_core.QVariant {
...
func (ptr *BridgeTemplate) ConnectSendVariantListMap(f func(v0 *std_core.QVariant, v1 []*std_core.QVariant, v2 map[string]*std_core.QVariant)) {
	if ptr.Pointer() != nil {
...
func (ptr *BridgeTemplate) SendVariantListMap(v0 std_core.QVariant_ITF, v1 []*std_core.QVariant, v2 map[string]*std_core.QVariant) {
	if ptr.Pointer() != nil {
...
func BridgeTemplate_QmlRegisterUncreatableType(uri string, versionMajor int, versionMinor int, qmlName string, message string) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
	...
	return int(int32(C.BridgeTemplatece8f65_BridgeTemplatece8f65_QmlRegisterUncreatableType(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC, C.struct_Moc_PackedString{data: messageC, len: C.longlong(len(message))})))
}

func (ptr *BridgeTemplate) QmlRegisterUncreatableType(uri string, versionMajor int, versionMinor int, qmlName string, message string) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
...
func (ptr *BridgeTemplate) __sendVariantListMap_v2_keyList() []string {
	if ptr.Pointer() != nil {
		return func(l C.struct_Moc_PackedList) []string {
			...
			return out
		}(C.BridgeTemplatece8f65___sendVariantListMap_v2_keyList(ptr.Pointer()))
	}
	return make([]string, 0)
}
...
func NewBridgeTemplate(parent std_core.QObject_ITF) *BridgeTemplate {
	BridgeTemplate_QRegisterMetaType()
...
func callbackCustomLabelce8f65_Constructor(ptr unsafe.Pointer) {
...
func CustomLabel_QmlRegisterUncreatableType(uri string, versionMajor int, versionMinor int, qmlName string, message string) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
	...
	return int(int32(C.CustomLabelce8f65_CustomLabelce8f65_QmlRegisterUncreatableType(uriC, C.int(int32(versionMajor)), C.int(int32(versionMinor)), qmlNameC, C.struct_Moc_PackedString{data: messageC, len: C.longlong(len(message))})))
}

func (ptr *CustomLabel) QmlRegisterUncreatableType(uri string, versionMajor int, versionMinor int, qmlName string, message string) int {
	var uriC *C.char
	if uri != "" {
		uriC = C.CString(uri)
		defer C.free(unsafe.Pointer(uriC))
